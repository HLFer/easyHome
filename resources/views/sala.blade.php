...
<div class="container mainclass">
    ...
    <div class="w-25 p-3"><a type="button" class="btn btn-success btn-lg btn-responsive" href="lampada/ligar/sala">Ligar Lâmpada</a></div>
    <div class="w-25 p-3"><a type="button" class="btn btn-danger btn-lg btn-responsive" href="lampada/desligar/sala">Desligar Lâmpada</a></div>
